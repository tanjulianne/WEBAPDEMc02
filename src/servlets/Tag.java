/*
Tag.java [Servlet]
Handles tagging requests from within a Photo Frame
NOTE: modifies the user database. Please make sure your connections are set and are valid.
      Tag servlet uses redirects instead of includes/forwards due to it's client JSP
...
public class Tag extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Update the database
        try {
            String sql = "INSERT INTO tags (title, owner, tag) VALUES ('" + title + "', '" + owner + "', '" + tag + "');";
            SQLHelper.updateDatabase(sql);
            shareMessage = "<p><font color='green'>Successfully added tag #" + tag + "!</font></p>";
        } catch (Exception e) {
            e.printStackTrace();
