...
<nav class="navbar navbar-fixed-top navbar-inverse">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <div class="flex">
            ...
            <form method="post" action="PhotoGrid" class="nav navbar-nav" id="nav">
                ...
                <input type="submit" value="Public" id="nav-button" />
            </form>
            </div>
          </div>
  ...
  <div class="user">
    <header class="user__header">
        <h1 class="user__title">Register Your Account</h1>
    </header>
    ...
    <form class="form" action="Register" method="POST">
        ...
        <div class="form__group">
            <input type="password" name = "confirmpassword" placeholder="Confirm Password" class="form__input" />
        </div>
        
        <div class="form__group">
            <input type= "text" name = "description" id = "des" placeholder="Describe yourself in a sentence" class="form__input" />
        </div>
